...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(! sp.getString("remember" , "").equals(""))
        {
    ...
    public void login(final View v) {
        ...
        if (UserName.equals("")) {
            Toast.makeText(MainActivity.this, "Please enter your Employee ID", Toast.LENGTH_SHORT).show();
            return;
        }
        if (Password.equals("")) {
        ...
        JsonObjectRequest jobjreq = new JsonObjectRequest("http://"+Ipaddress.ip+"/test.php", js, new Response.Listener<JSONObject>() {
            @Override
