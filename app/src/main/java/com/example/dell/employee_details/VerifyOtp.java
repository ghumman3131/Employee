...
public class VerifyOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(VerifyOtp.this , String.valueOf(pin) ,Toast.LENGTH_SHORT ).show();
        ...
        otp4.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(s.length() == 1)
                {
                    ...
                    if(fin_pin == pin)
                    {
                        Intent i = new Intent(VerifyOtp.this , ChangePassword.class);

                        i.putExtra("eid" , getIntent().getStringExtra("eid") );
                        startActivity(i);
                        finish();
                    }
